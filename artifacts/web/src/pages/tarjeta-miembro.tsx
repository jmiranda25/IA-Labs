...
export default function TarjetaMiembroPage({ username }: { username: string }) {
  ...
  const ogDescription = card.bio ?? `Mira la tarjeta de miembro de @${card.username} en la comunidad hispana de IA.`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[hsl(224_71%_4%)] via-[hsl(224_71%_6%)] to-[hsl(270_50%_10%)]">
      <Helmet>
        ...
        {card.avatarUrl && <meta property="og:image" content={card.avatarUrl} />}
      ...
      <div className="max-w-lg mx-auto px-4 py-12 flex flex-col gap-6">
        ...
        <div className="flex items-center justify-between">
          <Link href={`${basePath}/`}>
            <span className="flex items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity">
              ...
              <span className="font-bold text-foreground tracking-tight text-sm">AI Community</span>
            </span>
          </Link>
          <Button
            variant="ghost"
        ...
        {/* Main card */}
        <div className="rounded-2xl border border-border/50 bg-card/60 backdrop-blur-sm overflow-hidden shadow-2xl shadow-black/40">
